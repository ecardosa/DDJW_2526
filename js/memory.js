...
const savedOptions = localStorage.options
...
var game = {
  ...
  select: function () {
    if (sessionStorage.load) {
      ...
      if (sessionStorage.nextLevel) {
        this.level = parseInt(sessionStorage.nextLevel);
  ...
  start: function () {
    this.items.forEach((_, indx) => {
      if (
        this.states[indx] === StateCard.DISABLE ||
  ...
  _nextLevel: function () {
    ...
    sessionStorage.nextLevel = this.level;
